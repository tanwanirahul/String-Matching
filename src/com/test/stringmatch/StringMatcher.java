...
import com.test.stringmatch.lib.STrie;
...
public class StringMatcher
{
    ...
    {
        return trie.removeComplete(exact_str);
    }
    ...
    {
        return trie.removePrefix(prefix_str);
    }
};
